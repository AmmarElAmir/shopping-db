...
export function IconMic(props) {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="5.5" y="1.5" width="5" height="8" rx="2.5" stroke="currentColor" strokeWidth="1.2" fill="none" />
      <path d="M3 7.5v.5a5 5 0 0 0 10 0v-.5M8 13v1.5M5.5 14.5h5"
...
export function IconAddList(props) {
  return (
    <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M2 4h8M2 8h5M2 12h5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M12 8v5M9.5 10.5h5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
